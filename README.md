...
Key highlights:  
- Built **automated NGS pipelines** (Nextflow/Snakemake on AWS/GCP) cutting runtime by **50%**  
- Developed scalable **RNA‑Seq, scRNA‑Seq & long‑read workflows**  
- Built full‑stack tools using **React, FastAPI, Node.js, Flask, SQL**  
- Developed **RAG + LLM systems**, biomedical GenAI pipelines  
- Built YOLO‑powered **real‑time object detection** deployed on Raspberry Pi  
...
- ONNX + quantization for optimized inference  
- Integrated multimodal assistant (voice + text)
...
- Secure APIs (JWT)  
- Real‑time analytics  
- ETL pipelines pulling data from ClinicalTrials.gov  
...
- Ability to architect scalable cloud systems  
- Full‑stack mindset with deep bioinformatics experience  
