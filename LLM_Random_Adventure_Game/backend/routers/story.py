...
from schemas.story import (CompleteStoryNodeResponse, CreateStoryRequest, CompleteStoryResponse)
...
def create_story(
    ...
    job = StoryJob(id=job_id, job_id=job_id, session_id=session_id, status="pending", theme=request.theme)
    db.add(job)
    db.commit()
